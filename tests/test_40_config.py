...
class TestSetRepoSettings:
    def test_sets_all_settings(self):
        repo = MagicMock()
        set_repo_settings(repo, delete_branch_on_merge=True)
    ...
    def test_delete_branch_false_for_dev_repos(self):
        repo = MagicMock()
        set_repo_settings(repo, delete_branch_on_merge=False)
    ...
    def test_dry_run(self):
        repo = MagicMock()
        set_repo_settings(repo, delete_branch_on_merge=True, dry_run=True)
        repo.edit.assert_not_called()
