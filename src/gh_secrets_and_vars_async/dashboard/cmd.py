"""Click command for the v2 dashboard (`ai-gh dashboard`).

Shares flag surface with v1 `ai-gh panel`; adds ``--layout`` and changes the
default theme to ``paper``.
"""
...
def dashboard_command(
    ...
    try:
        ...
        raise click.ClickException(
            "textual is required for dashboard. Install with: uv add 'augint-github[tui]'"
        ) from exc
